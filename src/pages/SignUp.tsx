    ...
    <div className="relative flex min-h-screen flex-col items-center justify-center bg-[#0a0a0a] px-4 py-20 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-[420px] mb-8 text-center space-y-6">
        <div className="flex justify-center flex-col items-center gap-2">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-base text-white-64">Start your journey toward a clear path</p>
          </div>
        </div>
      </div>
      ...
      <div className="relative z-10 w-full max-w-[420px]">
        ...
        <div className="mt-8 text-center text-sm text-white-40">
          ...
          <Link to="/signin" className="font-semibold text-accent hover:text-accent/80 transition-colors">
            Sign in
          </Link>
        </div>
      </div>
